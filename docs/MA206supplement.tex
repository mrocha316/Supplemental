...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{houses <-}\StringTok{ }\KeywordTok{read_csv}\NormalTok{(}\DataTypeTok{file =} \StringTok{"./data/houses.csv"}\NormalTok{)}

\NormalTok{houses }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \StringTok{`}\DataTypeTok{SQUARE FEET}\StringTok{`}\NormalTok{, }
             \DataTypeTok{y =}\NormalTok{ PRICE,}
             \DataTypeTok{color =}\NormalTok{ CITY)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_point}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x =} \StringTok{"House size (sq ft)"}\NormalTok{,}
       \DataTypeTok{y =} \StringTok{"Sales price ($)"}\NormalTok{,}
       \DataTypeTok{color =} \StringTok{"Location"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model_main_effect <-}\StringTok{ }\NormalTok{houses }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{lm}\NormalTok{(PRICE }\OperatorTok{~}\StringTok{ `}\DataTypeTok{SQUARE FEET}\StringTok{`}\NormalTok{, }\DataTypeTok{data =}\NormalTok{ .)}

\KeywordTok{summary}\NormalTok{(model_main_effect)}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x =} \StringTok{"House size (sq ft)"}\NormalTok{,}
       \DataTypeTok{y =} \StringTok{"Sales price ($)"}\NormalTok{,}
       \DataTypeTok{color =} \StringTok{"Location"}\NormalTok{) }\OperatorTok{+}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model_interaction <-}\StringTok{ }\NormalTok{houses }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{lm}\NormalTok{(PRICE }\OperatorTok{~}\StringTok{ `}\DataTypeTok{SQUARE FEET}\StringTok{`}\OperatorTok{*}\NormalTok{CITY, }\DataTypeTok{data =}\NormalTok{ .)}

\KeywordTok{summary}\NormalTok{(model_interaction)}
\end{Highlighting}
\end{Shaded}
