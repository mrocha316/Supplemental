...
\section{\texorpdfstring{Unadjusted effect of \(X\) on \(Y\)}{Unadjusted effect of X on Y}}\label{unadjusted-effect-of-x-on-y-1}}
...
\section{\texorpdfstring{Effect of \(X\) on \(Y\) adjusting for \(C\)}{Effect of X on Y adjusting for C}}\label{effect-of-x-on-y-adjusting-for-c-1}}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{hist}\NormalTok{(size\_age\_mod}\SpecialCharTok{$}\NormalTok{residuals)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{houses }\OtherTok{\textless{}{-}} \FunctionTok{read\_csv}\NormalTok{(}\AttributeTok{file =} \StringTok{"./data/houses.csv"}\NormalTok{)}

\NormalTok{houses }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =} \StringTok{\textasciigrave{}}\AttributeTok{SQUARE FEET}\StringTok{\textasciigrave{}}\NormalTok{, }
             \AttributeTok{y =}\NormalTok{ PRICE,}
             \AttributeTok{color =}\NormalTok{ CITY)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"House size (sq ft)"}\NormalTok{,}
       \AttributeTok{y =} \StringTok{"Sales price ($)"}\NormalTok{,}
...
\includegraphics{MA206supplement_files/figure-latex/unnamed-chunk-27-1.pdf}
...
\includegraphics{MA206supplement_files/figure-latex/unnamed-chunk-31-1.pdf}
...
\begin{figure}
\centering
\includegraphics{MA206supplement_files/figure-latex/unnamed-chunk-32-1.pdf}
...
\begin{figure}
\centering
\includegraphics{MA206supplement_files/figure-latex/unnamed-chunk-33-1.pdf}
